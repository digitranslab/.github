...
|------------|-------------|
| 🏛️ **Data Architecture** | Design scalable architectures using medallion patterns (Bronze, Silver, Gold) |
| 🔄 **Data Integration** | Connect disparate sources into unified, governed data platforms |
| 📊 **Data Modelling** | Create dimensional models optimised for analytics and reporting |
| 🔒 **Data Governance** | Implement access controls, lineage tracking, and quality monitoring |
| ⚡ **Performance Optimisation** | Tune queries, partitioning, and caching for optimal performance |
| 💰 **Cost Management** | Design for cost efficiency with auto-scaling and resource optimisation |
...
│   │  (Raw)   │    │ (Cleaned)│    │(Curated) │    │  Consumption Layer   │  │
│   └──────────┘    └──────────┘    └──────────┘    └──────────────────────┘  │
│                                                                              │
│   • Raw ingestion   • Cleansed data   • Business-ready   • BI dashboards   │
│   • Schema-on-read  • Validated       • Aggregated       • ML features     │
│   • Full history    • Deduplicated    • Conformed        • API access      │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
